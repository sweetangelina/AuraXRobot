...
from AuraX import OWNER_ID, bot, devs
from AuraX.services.mongo import mongodb
from AuraX.utils.logger import log
from AuraX.versions import DB_STRUCTURE_VER
...
if not (data := mongodb.db_structure.find_one({"db_ver": {"$exists": True}})):
    ...
    if DB_STRUCTURE_VER > curr_ver:
        ...
        while curr_ver < DB_STRUCTURE_VER:
            ...
            log.debug("Importing: AuraX.db." + str(new_ver))
            import_module("AuraX.db." + str(new_ver))
