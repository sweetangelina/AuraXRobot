# Ported by @IisGaurav From William Butcher Bot
...
@app.on_message(filters.command("strgen") & filters.private)
...
_help = """
 * String Generator Generates Only Pyrogram String Session*
 ✪ /strgen : Type in Pm of bot to generate Pyrogram string session. 
"""

_mod_name_ = "String Gen"
