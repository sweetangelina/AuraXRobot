...
__help__ = """
 ...
 AuraXMUSIC plays plays music in your group's voice chat
 
 Assistant name >> @AuraXhelper
...
*) If userbot joined enjoy music, If not add @AuraXhelper to your group and retry
...
=>> More tools 🧑‍🔧
  ...
  /userbotjoin: Invite @AuraXhelper Userbot to your chat
