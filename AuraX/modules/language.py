...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["crowdin_btn"], url="https://crowdin.com/project/AuraXx"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising AuraXRobot's localization feature! You can also <a href='https://crowdin.com/project/AuraXx'>contribute</a> for improving localization in AuraXRobot!
...
AuraXRobot will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
