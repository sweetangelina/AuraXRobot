...
from AuraX import BOT_USERNAME, OWNER_ID
from AuraX.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from AuraX.function.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/AuraXRobot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[AuraX✨](https://github.com/TeamAuraX):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/AuraXhelper)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/d7bce21fd887bed551f42.png",
