...
from AuraX import TOKEN, bot, dp
from AuraX.config import get_bool_key, get_list_key
from AuraX.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("AuraX.modules." + module_name)
...
import_module("AuraX.modules.pm_menu")
# Import misc stuff
import_module("AuraX.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("AuraX.utils.sentry")
